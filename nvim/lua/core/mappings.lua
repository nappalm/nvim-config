...
maps.n["<leader>/"] = { "<cmd>noh<cr>", desc = "Remove Search Highlight" }
...
if is_available "bufdelete.nvim" then
  maps.n["q"] = { "<cmd>Bdelete<cr>", desc = "Close window" }
else
  maps.n["q"] = { "<cmd>bdelete<cr>", desc = "Close window" }
end
...
if is_available "Comment.nvim" then
  maps.n["cm"] = { function() require("Comment.api").toggle.linewise.current() end, desc = "Comment line" }
  maps.v["cm"] = {
...
if is_available "smart-splits.nvim" then
  ...
  maps.n["sv"] = { "<cmd>vsp<cr>", desc = "Vertical split" }
  maps.n["sh"] = { "<cmd>sp<cr>", desc = "Horizontal split" }
  maps.n["fk"] = { "<cmd>q!<cr>", desc = "Force Kit" }

  -- New tab
  maps.n["<C-n>"] = { ":tabnew<cr>", desc = "New tab" }
